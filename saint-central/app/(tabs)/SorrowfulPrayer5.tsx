...
// Fourth Sorrowful Mystery-specific content
const FOURTH_MYSTERY_CONTENT = {
  title: "The Carrying of the Cross",
  description: "They took Jesus, and carrying the cross himself he went out to what is called the Place of the Skull, in Hebrew, Golgotha. (John 19:17)",
  reflection: "Jesus embraces His cross and carries it to Calvary, accepting the weight of our sins. Though weakened by suffering, He perseveres out of love for humanity. In our own struggles, we are invited to unite our crosses with His."
};

export default function SorrowfulPrayer5Screen() {
  ...
  const { 
    ...
    mysteryIndex = "3", 
    mysteryTitle = FOURTH_MYSTERY_CONTENT.title, 
    mysteryDescription = FOURTH_MYSTERY_CONTENT.description, 
    guideName 
  } = params;
  ...
  const prayers = [
    { id: 0, title: "Fourth Mystery: The Carrying of the Cross", text: FOURTH_MYSTERY_CONTENT.description },
    ...
    try {
      if (isPlaying) {
        ...
        if (!result) {
          ...
          await audioManager.playMystery(mysteryKey as string || "SORROWFUL", parseInt(mysteryIndex as string) || 3);
        }
        setIsPlaying(true);
      }
    } catch (error) {
  ...
  const navigateToNext = () => {
    router.push({
      ...
      params: {
        ...
        mysteryDescription: "They crucified him, and with him two others, one on either side, with Jesus in the middle. (John 19:18)",
  ...
  const navigateToPrevious = () => {
    router.push({
      ...
      params: {
        ...
        mysteryDescription: "The soldiers wove a crown out of thorns and placed it on his head, and clothed him in a purple cloak. (John 19:2)",
        guideName: selectedGuide.name
      }
    });
  };
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleContainer}>
            <Text style={styles.headerTitle}>Fourth Sorrowful Mystery</Text>
          </View>
        ...
        >
          ...
          >
            <View style={styles.mysteryIconContainer}>
              <FontAwesome5 name="cross" size={24} color="#FFF" />
            </View>
            <Text style={styles.mysteryTitle}>{FOURTH_MYSTERY_CONTENT.title}</Text>
            <Text style={styles.mysteryScripture}>{FOURTH_MYSTERY_CONTENT.description}</Text>
            <View style={styles.mysteryReflectionContainer}>
              <Text style={styles.mysteryReflection}>{FOURTH_MYSTERY_CONTENT.reflection}</Text>
            </View>
          </Animated.View>
            ...
            <ScrollView style={styles.fullPrayerScrollView}>
              <View style={styles.fullPrayerContent}>
                <Text style={styles.fullPrayerText}>
                  {currentPrayerStep === 0 && FOURTH_MYSTERY_CONTENT.description}
