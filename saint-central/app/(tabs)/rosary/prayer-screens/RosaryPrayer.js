...
const RosaryPrayer = ({ route }) => {
  ...
  const handleVoiceChange = (voice) => {
    ...
    if (audioDuration > 0) {
      ...
      console.log(
        `Saving position at ${Math.round(percentage * 100)}% (${seekPos}ms) before changing voice`,
      );
  ...
  const getMysteryContent = () => {
    ...
    const introductionPrayers = {
      joyful:
        "In the Joyful Mysteries, we contemplate the joy of Mary's heart in the Incarnation. We ask for the virtue of humility, love of neighbor, and detachment from the world.",
      sorrowful:
        "In the Sorrowful Mysteries, we contemplate the suffering and death of Our Lord. We ask for contrition for our sins, patience in adversity, and strength in temptation.",
      glorious:
        "In the Glorious Mysteries, we contemplate the victory of Christ and the glory of Mary. We ask for perseverance, devotion to Mary, and the grace of a happy death.",
      luminous:
        "In the Luminous Mysteries, we contemplate Christ's public ministry. We ask for openness to the Holy Spirit, Christian witness, and trust in Christ.",
    };
    ...
    const introductionPrayer =
      introductionPrayers[currentMysteryType] || introductionPrayers["joyful"];
  ...
  const handlePrayerCompletion = async () => {
    try {
      ...
      const currentMysteryName =
        mysteryTypeData[mysteryType]?.name || (mysteryType || "Unknown").toUpperCase();
      const prayerRecord = {
              ...
              >
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        currentVoice === voiceKey ? `${themeColors.primary}20` : "#f5f5f5",
                    },
                  ]}
                >
                  <Ionicons
  ...
  const renderFinishButton = () => {
    ...
    return (
      <Animated.View style={[styles.finishButtonContainer, { opacity: fadeAnim }]}>
        <TouchableOpacity
  ...
  const renderContent = () => {
    if (currentScreen === "introduction") {
      ...
      return (
        <View style={[styles.contentContainer, isTransitioning && styles.fadeContent]}>
          ...
          <View style={[styles.prayerContainer, { borderLeftColor: themeColors.primary }]}>
            ...
            <Text style={styles.prayer}>
              ...
              heaven, sits at the right hand of God, the Father Almighty; from thence He shall come
          ...
          <View style={[styles.prayerContainer, { borderLeftColor: themeColors.primary }]}>
            ...
            <Text style={styles.prayer}>
              ...
              sinners, now and at the hour of our death. Amen. (3x)
            </Text>
          </View>
        ...
        <View style={[styles.contentContainer, isTransitioning && styles.fadeContent]}>
          ...
          <View style={[styles.prayerContainer, { borderLeftColor: themeColors.primary }]}>
            ...
            <Text style={styles.prayer}>
              Hail Mary, full of grace, the Lord is with thee; blessed art thou among women, and
              blessed is the fruit of thy womb, Jesus. Holy Mary, Mother of God, pray for us
              sinners, now and at the hour of our death. Amen. (10x)
            </Text>
          </View>
        ...
        <View style={[styles.contentContainer, isTransitioning && styles.fadeContent]}>
          ...
          <View style={[styles.prayerContainer, { borderLeftColor: themeColors.primary }]}>
            ...
            <Text style={styles.prayer}>
              ...
              weeping in this valley of tears. Turn, then, most gracious Advocate, thine eyes of
              mercy toward us, and after this, our exile, show unto us the blessed fruit of thy
          ...
          <View style={[styles.prayerContainer, { borderLeftColor: themeColors.primary }]}>
            ...
            <Text style={styles.prayer}>
              ...
              meditating upon these mysteries of the Most Holy Rosary of the Blessed Virgin Mary, we
              may imitate what they contain and obtain what they promise, through the same Christ
              our Lord. Amen.
            </Text>
          </View>
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.guideButton} onPress={() => setShowGuideSelector(true)}>
            <LinearGradient
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View
          style={[styles.audioPlayerContainer, { backgroundColor: `${themeColors.primary}10` }]}
        >
          {audioSource ? (
            <AudioPlayer
        ...
        <View style={styles.navigationContainer}>
          {currentScreen !== "introduction" && (
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Ionicons name="arrow-back" size={18} color="#666" style={{ marginRight: 8 }} />
