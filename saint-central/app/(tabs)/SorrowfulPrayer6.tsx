...
// Fifth Sorrowful Mystery-specific content
const FIFTH_MYSTERY_CONTENT = {
  title: "The Crucifixion",
  description: "When they came to the place called the Skull, they crucified him and the criminals there, one on his right, the other on his left. Then Jesus said, \"Father, forgive them, they know not what they do.\" (Luke 23:33-34)",
  reflection: "Jesus gave His life on the cross out of love for us. In His final moments, He forgave those who crucified Him, entrusted His mother to John, and surrendered His spirit to the Father. Through His sacrifice, He opened the gates of heaven and brought us salvation."
};

export default function SorrowfulPrayer6Screen() {
  ...
  const { 
    ...
    mysteryIndex = "4", 
    mysteryTitle = FIFTH_MYSTERY_CONTENT.title, 
    mysteryDescription = FIFTH_MYSTERY_CONTENT.description, 
    guideName 
  } = params;
  ...
  const prayers = [
    { id: 0, title: "Fifth Mystery: The Crucifixion", text: FIFTH_MYSTERY_CONTENT.description },
    ...
    try {
      if (isPlaying) {
        ...
        if (!result) {
          ...
          await audioManager.playMystery(mysteryKey as string || "SORROWFUL", parseInt(mysteryIndex as string) || 4);
        }
        setIsPlaying(true);
      }
    } catch (error) {
  ...
  const navigateToNext = () => {
    router.push({
      pathname: '/SorrowfulPrayer7' as any,
      params: {
  ...
  const navigateToPrevious = () => {
    router.push({
      pathname: '/SorrowfulPrayer5' as any,
      params: {
        mysteryType: "SORROWFUL",
        mysteryKey: "SORROWFUL",
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleContainer}>
            <Text style={styles.headerTitle}>Fifth Sorrowful Mystery</Text>
          </View>
        ...
        >
          ...
          >
            ...
            <Text style={styles.mysteryTitle}>{FIFTH_MYSTERY_CONTENT.title}</Text>
            <Text style={styles.mysteryScripture}>{FIFTH_MYSTERY_CONTENT.description}</Text>
            <View style={styles.mysteryReflectionContainer}>
              <Text style={styles.mysteryReflection}>{FIFTH_MYSTERY_CONTENT.reflection}</Text>
            </View>
          </Animated.View>
          ...
          <View style={styles.progressNavigationContainer}>
            ...
            >
              <Text style={styles.progressNavText}>Conclusion</Text>
            ...
            <ScrollView style={styles.fullPrayerScrollView}>
              <View style={styles.fullPrayerContent}>
                <Text style={styles.fullPrayerText}>
                  {currentPrayerStep === 0 && FIFTH_MYSTERY_CONTENT.description}
