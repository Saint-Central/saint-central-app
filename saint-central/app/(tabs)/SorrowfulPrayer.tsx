...
// Custom content specific to Sorrowful Mysteries
const SORROWFUL_REFLECTIONS = [
  "As we pray the Sorrowful Mysteries, we contemplate Christ's suffering and passion.",
  "The Sorrowful Mysteries remind us of the depths of God's love, shown through Christ's willingness to suffer for our salvation.",
  "In meditating on Christ's agony, we unite our own sufferings with His.",
  "These mysteries guide us through the path of redemption, from the Garden of Gethsemane to Calvary."
];

export default function SorrowfulPrayerScreen() {
  ...
  const theme = getMysteryTheme(mysteryKey as string || "SORROWFUL");
  ...
  // Display a random reflection
  const [currentReflection, setCurrentReflection] = useState(
    SORROWFUL_REFLECTIONS[Math.floor(Math.random() * SORROWFUL_REFLECTIONS.length)]
  );
  ...
  const prayers = mysteryType === "INTRODUCTION" 
    ...
    : [
      { id: 5, title: "First Mystery: The Agony in the Garden", text: "Then Jesus came with them to a place called Gethsemane, and he said to his disciples, 'Sit here while I go over there and pray.' He took along Peter and the two sons of Zebedee, and began to feel sorrow and distress. (Matthew 26:36-37)" },
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleContainer}>
            <Text style={styles.headerTitle}>{mysteryType || "Sorrowful Mysteries"}</Text>
          </View>
        ...
        >
          ...
          >
            <View style={styles.reflectionIconContainer}>
              <FontAwesome5 name="heart-broken" size={20} color="#FFF" />
            </View>
            <Text style={styles.reflectionText}>{currentReflection}</Text>
          </Animated.View>
