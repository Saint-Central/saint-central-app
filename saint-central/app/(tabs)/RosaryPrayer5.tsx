...
export default function RosaryPrayerScreen() {
  ...
  const prayers = mysteryType === "INTRODUCTION" 
    ...
    : [
      { id: 5, title: "Fourth Mystery: The Annunciation", text: "And when the time came for their purification according to the law of Moses, they brought him up to Jerusalem to present him to the Lord (as it is written in the law of the Lord, 'Every male that opens the womb shall be called holy to the Lord'). (Luke 2:22-23)" },
  ...
  const prayerKeyPhrases = mysteryType === "INTRODUCTION"
    ...
    : [
        ...
        { phrase: "Glory be to the Father", timestamp: 140000 },              // Glory Be
        { phrase: `${mysteryTitle || "Fourth Mystery:"}`, timestamp: 170000 }, // Announce Mystery
