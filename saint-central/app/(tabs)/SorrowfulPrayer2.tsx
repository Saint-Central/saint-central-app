...
// First Sorrowful Mystery-specific content
const FIRST_MYSTERY_CONTENT = {
  ...
  reflection: "In the Garden of Gethsemane, Jesus experienced the full weight of our sins. He prayed, 'Father, if it is possible, let this cup pass from me; yet, not as I will, but as you will.' His sacrifice began with this loving surrender to the Father's will."
};

export default function SorrowfulPrayer2Screen() {
  ...
  const { 
    ...
    mysteryIndex = "0", 
    mysteryTitle = FIRST_MYSTERY_CONTENT.title, 
    mysteryDescription = FIRST_MYSTERY_CONTENT.description, 
    guideName 
  } = params;
  ...
  const prayers = [
    { id: 0, title: "First Mystery: The Agony in the Garden", text: FIRST_MYSTERY_CONTENT.description },
    ...
    try {
      if (isPlaying) {
        ...
        if (!result) {
          ...
          await audioManager.playMystery(mysteryKey as string || "SORROWFUL", parseInt(mysteryIndex as string) || 0);
        }
        setIsPlaying(true);
      }
    } catch (error) {
  ...
  const navigateToNext = () => {
    router.push({
      pathname: '/SorrowfulPrayer3' as any,
      params: {
        mysteryType: "SORROWFUL",
        mysteryKey: "SORROWFUL",
  ...
  const navigateToPrevious = () => {
    router.push({
      pathname: '/SorrowfulPrayer' as any,
      params: {
        mysteryType: "INTRODUCTION",
        mysteryKey: "SORROWFUL",
        mysteryIndex: 0,
        mysteryTitle: "Introduction",
        mysteryDescription: "Introduction to the Sorrowful Mysteries",
        guideName: selectedGuide.name
      }
    });
  };
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleContainer}>
            <Text style={styles.headerTitle}>First Sorrowful Mystery</Text>
          </View>
        ...
        >
          ...
          >
            ...
            <Text style={styles.mysteryTitle}>{FIRST_MYSTERY_CONTENT.title}</Text>
            <Text style={styles.mysteryScripture}>{FIRST_MYSTERY_CONTENT.description}</Text>
            <View style={styles.mysteryReflectionContainer}>
              <Text style={styles.mysteryReflection}>{FIRST_MYSTERY_CONTENT.reflection}</Text>
            </View>
          </Animated.View>
          ...
          <View style={styles.progressNavigationContainer}>
            ...
            >
              ...
              <Text style={styles.progressNavText}>Introduction</Text>
            </TouchableOpacity>
            ...
            <ScrollView style={styles.fullPrayerScrollView}>
              <View style={styles.fullPrayerContent}>
                <Text style={styles.fullPrayerText}>
                  {currentPrayerStep === 0 && FIRST_MYSTERY_CONTENT.description}
