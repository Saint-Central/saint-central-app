...
const CreateYouthGroupPage: React.FC = () => {
  ...
  const updateField = (field: keyof YouthGroup, value: string | null | boolean | number | RecurringType): void => {
    setFormData(prevData => ({
      ...prevData,
      [field]: value
    }));
  ...
  const handleSave = async (): Promise<void> => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        Alert.alert(
          'Success', 
          'Youth Group updated successfully',
          [{ text: 'OK', onPress: () => router.push({ pathname: "/(tabs)/YouthGroupSchedulePage" }) }]
        );
      } else {
        ...
        Alert.alert(
          'Success', 
          'Youth Group created successfully',
          [{ text: 'OK', onPress: () => router.push({ pathname: "/(tabs)/YouthGroupSchedulePage" }) }]
        );
      }
    } catch (error) {
        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.noPermissionContainer}>
            ...
            <Text style={styles.noPermissionText}>
              You do not have permission to create or edit Youth Groups.
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.fieldContainer}>
              ...
              <View style={styles.enhancedInputContainer}>
                <FontAwesome5 name="users" size={18} color={theme.accent1} style={styles.inputIcon} />
                <TextInput
              ...
              <Text style={styles.helperText}>
                A clear, descriptive title for your Youth Group
              </Text>
            </View>
            ...
            <View style={styles.fieldContainer}>
              ...
              <Text style={styles.helperText}>
                ...
                {formData.recurring_type === 'daily' && 'This Youth Group will repeat every day at the same time and location.'}
                {formData.recurring_type === 'weekly' && 'This Youth Group will repeat every week on this day at the same time and location.'}
                {formData.recurring_type === 'monthly' && 'This Youth Group will repeat monthly on this date at the same time and location.'}
                {formData.recurring_type === 'yearly' && 'This Youth Group will repeat yearly on this date at the same time and location.'}
              </Text>
            </View>
