...
export default function RosaryPrayerScreen() {
  ...
  const prayers = mysteryType === "INTRODUCTION" 
    ...
    : [
      { id: 5, title: "Second Mystery: INTRODUCTION", text: "And Mary arose and went with haste into the hill country, to a city of Judah, and she entered the house of Zechariah and greeted Elizabeth. And when Elizabeth heard the greeting of Mary, the babe leaped in her womb; and Elizabeth was filled with the Holy Spirit." },
